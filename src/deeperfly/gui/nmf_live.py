...
registration, and the pipeline measures those *after* pinning ``constant_points`` -- so
re-deriving them here from the editor's unpinned pose would quietly fit a slightly
different animal than the stored result did.
